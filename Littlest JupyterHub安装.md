...
** The Littlest JupyterHub** 支持云端安装和本地安装，本教程介绍在**Ubuntu 20.04**本地安装**TLJH**，预备工作：首先需要如果您的云提供商没有直接教程，或者 您正在裸机服务器上进行此设置。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEzMDk0MTc2MSwtMTcyMzQ1MjQ5MF19
-->